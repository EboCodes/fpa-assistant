  ...
  return (
    <header className="site-header">
      <div className="site-header-inner">
        ...
        <nav className={`site-nav ${mobileNavOpen ? 'mobile-nav-open' : ''}`}>
          <Link
            to="/"
          ...
          {user ? (
            <div className="auth-status-wrap">
              ...
              <button className="btn-logout" onClick={() => { setMobileNavOpen(false); onLogout(); }}>
                Sign Out
              </button>
            </div>
          ) : (
            <Link to="/login" className="btn-signin-nav" onClick={() => setMobileNavOpen(false)}>
              Sign In
            </Link>
          )}
        </nav>
      ...
      <section className="institutional-stats-strip">
        <div className="stat-pill-item">
          ...
          <div className="stat-pill-content">
            <span className="stat-pill-val">55+ Verified</span>
            <span className="stat-pill-lbl">Knowledge Articles</span>
          </div>
        </div>

        <div className="stat-pill-item">
          <div className="stat-pill-icon"><Icons.Globe /></div>
          <div className="stat-pill-content">
            <span className="stat-pill-val">Live Web Search</span>
            <span className="stat-pill-lbl">Gemini Grounding</span>
          </div>
        </div>

        <div className="stat-pill-item">
          <div className="stat-pill-icon"><Icons.Star /></div>
          <div className="stat-pill-content">
            <span className="stat-pill-val">95%+ Rating</span>
            <span className="stat-pill-lbl">Student Satisfaction</span>
          </div>
        </div>

        <div className="stat-pill-item">
          <div className="stat-pill-icon"><Icons.Sparkles /></div>
          <div className="stat-pill-content">
            <span className="stat-pill-val">24/7 Digital</span>
            <span className="stat-pill-lbl">Helpdesk Availability</span>
          </div>
        </div>
      </section>
          ...
          <div className="desk-topbar-left">
            ...
            <div className="desk-title-block">
              ...
              <span className="desk-status-tag">
                <span className="live-pulse-dot"></span>
                Connected &middot; Federal Polytechnic, Ado-Ekiti
              </span>
            </div>
          </div>

          <div className="desk-topbar-right">
            <div className="topbar-grounding-badge" title="Gemini Google Search Grounding is active for institutional & web retrieval">
              <Icons.Globe />
                    ...
                    <div className="speaker-badge-helpdesk">
                      ...
                      {m.responseMode === 'web_assisted' ? (
                        <span className="mode-pill mode-web" title="Includes Google Search Grounding references">
                          <Icons.Globe /> Grounded Web
                        </span>
                      ) : (
                        <span className="mode-pill mode-kb" title="Verified Federal Polytechnic Ado-Ekiti record">
                          <Icons.ShieldCheck /> Verified KB
                        </span>
                      )}
                    </div>
                  )}
                  ...
                  {m.role === 'assistant' && m.sources && m.sources.length > 0 && (
                    <div className="dialog-sources-container">
                      <div className="dialog-sources-header">
                        <Icons.Globe /> Referenced Sources
                      </div>
                    ...
                    m.messageId && (
                      <div className="dialog-feedback-row">
                        <span className="feedback-query">
                          Was this official response helpful?
                        </span>

                        {feedbackSent[m.messageId] ? (
                          <span className="feedback-success-ack">
                            <Icons.Check /> Thank you for your feedback
                          </span>
                        ) : (
                          <div className="feedback-btn-group">
                            <button
                              className="btn-feedback-action btn-feedback-positive"
                              onClick={() =>
                                submitFeedback(
                                  m.messageId,
                                  5
                            ...
                            <button
                              className="btn-feedback-action btn-feedback-negative"
                              onClick={() =>
                                submitFeedback(
                                  m.messageId,
                                  1
                            ...
                            >
                              <Icons.ThumbsDown /> Needs Improvement
                            </button>
                          </div>
                        )}
                      </div>
